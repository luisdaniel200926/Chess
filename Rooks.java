...
public class Rooks extends Pieces implements ILimited{
	 ...
	 * @param eat
	 */
	public Rooks(String color, Type type, int PosTiles,boolean eat) {
		super(color, type, PosTiles, eat);
		
	}

	final int nextMove[]= {-8,-1,1,8};
